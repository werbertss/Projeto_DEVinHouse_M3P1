...
public class DevInCarDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity
                .HasData(new[] {
                    new User (1, "jose@email.com", "123456opp78", "Jose", "Vendedor", new DateTime(2000, 12, 10)),
                    new User (2, "andrea@email.com", "987dasd654321", "Andrea", "Comprador", new DateTime(1999, 05, 11)),
                    new User (3, "adao@email.com", "2589asd", "Adao", "Comprador", new DateTime(2005, 09, 02)),
                    new User (4, "monique@email.com", "asd45uio", "Monique", "Gerente", new DateTime(2001, 06, 07)),
                });
        });
